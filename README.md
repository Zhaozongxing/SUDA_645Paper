...
attributes
- *(ISSTA'2024)* DistillSeq: A Framework for Safety Alignment Testing in Large Language Models using Knowledge Distillation [[paper]]
...
- *(ASE'2024)* iSMELL: Assembling LLMs with Expert Toolsets for Code Smell Detection and Refactoring [[paper]]
...
- *(ASE'2024)* How Effectively Do Code Language Models Understand Poor-Readability Code? [[paper]]
...
- *(ICSE'2025)* Vulnerability Detection with Code Language Models：How Far Are We [[paper]]
...
- *(ARXIV'2024)* Top Score on the Wrong Exam：On Benchmarking in Machine Learning for Vulnerability Detection [[paper]]
  **Authors:** Niklas Risse， Marcel Bohme ; **First Unit:** Bochum ; **Keywords:** Vulnerability Detection, function level
- *(ISSTA'2024)* FDI: Attack Neural Code Generation Systems through User Feedback Channel [[paper]]
...
- *(S&P'2024)* TROJANPUZZLE: Covertly Poisoning Code-Suggestion Models [[paper]]
...
- *(NAACL'2024)* A Wolf in Sheep’s Clothing: Generalized Nested Jailbreak Prompts can Fool Large Language Models Easily [[paper]]
  **Authors:** Peng Ding, Jun Kuang, Dan Ma, Xuezhi Cao, Yunsen Xian, Jiajun Chen, Shujian Huang ; **First Unit:** Nanjing University, Meituan Inc., China ; **Keywords:** Jailbreak; Large Language Model; Prompt Engineering
- *(USENIX Security'2023)* CodexLeaks: Privacy Leaks from Code Generation Language Models in GitHub Copilot [[paper]]
...
- *(ASE'2023)* Code Difference Guided Adversarial Example Generation for Deep Code Models [[paper]]
...
- *(TOSEM'2024)* CARL:Unsupervised Code-Based Adversarial Attacks for Programming Language Models via Reinforcement Learning [[paper]]
...
- *(ASE'2023)* Personalized First Issue Recommender for Newcomers in Open Source Projects [[paper]]
...
- *(ICSE'2023)* Is It Enough to Recommend Tasks to Newcomers? Understanding Mentoring on Good First Issues [[paper]]
...
- *(ASE'2023)* RMCBench: Benchmarking Large Language Models’ Resistance to Malicious Code [[paper]]
...
- *(ICSE'2025)* Similar but Patched Code Considered Harmful -- The Impact of Similar but Patched Code on Recurring Vulnerability Detection and How to Remove Them [[paper]]
...
- *(ARXIV'2023)* Context-Aware Code Generation Framework for Code Repositories: Local, Global, and Third-Party Library Awareness [[paper]]
...
- *(ICLR'2024)* Self-RAG: Learning to Retrieve, Generate, and Critique through Self-Reflection [[paper]]
...
- *(ASE'2023)*  CAT-LM Training Language Models on Aligned Code And Tests [[paper]]
...
- *(ISSTA'2024)* LLM-based Resource-Oriented Intention Inference for Static Resource Detection [[paper]]
  **Authors:** Chong Wang, Jianan Liu, Xin Peng, Yang Liu, YiLing Lou ; **First Unit:** Fudan University ; **Keywords:** leak detection, static analysis, LLM-based
...
- *(ASE'2023)* Unifying Defect Prediction, Categorization, and Repair by Multi-Task Deep Learning [[paper]]
...
- *(ESEC/FSE'2023)* Commit-Level, Neural Vulnerability Detection and Assessment [[paper]]
...
- *(ICSE'2023)* Vulnerability Detection with Graph Simplification and Enhanced Graph Representation Learning [[paper]]
...
- *(ASE'2023)* Domain Adaptive Code Completion via Language Models and Decoupled Domain Databases [[paper]]
...
- *(ICML'2023)* Repository-Level Prompt Generation for Large Language Models of Code [[paper]]
...
- *(ICSE'2024)*  Large Language Models are Few-Shot Summarizers: Multi-Intent Comment Generation via In-Context Learning [[paper]]
...
- *(ICSE'2024)* Evaluating Code Summarization Techniques: A New Metric and an Empirical Characterization [[paper]]
...
- *(ESEC/FSE'2023)* RAP-Gen: Retrieval-Augmented Patch Generation with CodeT5 for Automatic Program Repair [[paper]]
...
- *(ICSE'2024)* Towards Causal Deep Learning for Vulnerability Detection [[paper]]
...
- *(ESEC/FSE'2023)* Copiloting the Copilots: Fusing Large Language Models with Completion Engines for Automated Program Repair [[paper]]
...
- *(ARXIV'2023)* Keep the Conversation Going: Fixing 162 out of 337 bugs for $0.42 each using ChatGPT [[paper]]
...
- *(ASE'2023)* Revisiting the Plastic Surgery Hypothesis via Large Language Models [[paper]]
...
- *(ESEC/FSE'2023)* Tritor: Detecting Semantic Code Clones by Building Social Network-based Triads Model [[paper]]
...
- *(ASE'2023)* ZC3: Zero-Shot Cross-Language Code Clone Detection [[paper]]
  **Authors:** Jia Li, Chongyang Tao, Zhi Jin, Fang Liu, Jia Li, Ge Li ; **First Unit:** Key Lab of High Confidence Software
Technology, MoE (Peking University) ; **Keywords:** code clone detection, zero-shot learning, crosslanguage, deep neural networks
- *(ASE'2023)* CodeGen4Libs: A Two-Stage Approach for Library-Oriented Code Generation [[paper]]
...
Model
- *(ICSE'2024)* Knowledge Graph Driven Inference Testing for Question Answering Software [[paper]]
...
- *(ESEC/FSE'2023)* BiasAsker: Measuring the Bias in Conversational AI System [[paper]]
...
- *(ESEC/FSE'2023)* API-Knowledge Aware Search-Based Software Testing: Where, What, and How [[paper]]
...
- *(ESEC/FSE'2023)* Contextual Predictive Mutation Testing [[paper]]
...
- *(ESEC/FSE'2023)* Contextual Predictive Mutation Testing [[paper]]
  **Authors:** Jain, Kush and Alon, Uri and Groce, Alex and Le Goues, Claire ; **First Unit:** Carnegie Mellon University ; **Keywords:** test oracles, code coverage, mutation analysis
- *(ICSE'2024)* Universal Fuzzing via Large Language Models [[paper]]
...
- *(ESEC/FSE'2023)* Evaluating Transfer Learning for Simplifying GitHub READMEs [[paper]]
